                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$motor->year}} - {{$motor->maker->name}} {{$motor->motorModel->name}}</td>
                      <td>{{ $motor->getCreatedDate ()}}</td>
                      <td>{{$motor->published_at ? 'yes' : 'no'}}</td>
                      <td class="">
                        <a
                          href="{{route('motor.edit', $motor)}}"
                    ...
                    <tr>
                      <td colspan="5" class="text-center p-large">
                        You don't have any motor yet <a href="{{route('motor.create')}}">Add New Motor</a>
                      </td>
                    </tr>
                    @endforelse
